...
abstract class OrmLiteDao<T, K> implements BaseDao<T, K> {
    ...
    @Override
    public T get( K id ) throws DBException {
        try {
    ...
    @Override
    public List<String[]> queryRaw( String statement, String... arguments ) throws DBException {
        try {
     ...
     */
    @Override
    public boolean createOrUpdate( T entry ) throws DBException {
        try {
